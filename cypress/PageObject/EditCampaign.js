export class EditCampaigns {
  ...
  updateCampaignPrioritySlider() {
   cy.get('.p-slider .p-slider-handle').first()
    .focus()
    .type('{rightarrow}'); // or multiple if you want to increase more
   ...
   // cy.get('p-slider input').first().invoke('val').should('eq', newValue.toString());
